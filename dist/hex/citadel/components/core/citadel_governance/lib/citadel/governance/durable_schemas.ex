defmodule Citadel.Governance.DurableSchemas.DecisionSession do
  @moduledoc """
  Durable decision-session record returned by the Citadel authority API.

  Callers should create and close sessions through
  `Citadel.Governance.DurableAuthority`; this schema is public so the returned
  value and its typespec remain documented.
  """
...
defmodule Citadel.Governance.DurableSchemas.AuthorityDecision do
  @moduledoc """
  Immutable durable authority-decision record returned by the Citadel API.

  Persistence remains owned by `Citadel.Governance.DurableAuthority`; this
  schema is public because decisions are part of that module's return contract.
  """
